        ...
        <>
            <section className='hero-section'>
                <div className='flex items-center justify-center w-full h-[calc(100vh-4rem)]'>
                    ...
                    <div className='hero-content absolute flex items-center mediumTablet:flex-row largePhone:flex-col smallPhone:flex-col wideScreen:space-x-16 desktop:space-x-12 largeTablet:space-x-10 mediumTablet:space-x-8 mediumTablet:space-y-0 smallTablet:space-y-6 smallPhone:space-y-5'>
                        <div className="hero-img-area">
                            <img className='wideScreen:w-[38rem] desktop:w-[32rem] largeTablet:w-[26rem] mediumTablet:w-[22rem] largePhone:w-[20rem] smallPhone:w-[17rem]' src="/images/hero.svg" alt="hero-img" />
                        </div>
                        <div className="hero-text-area">
                            <h1 className='font-poppins wideScreen:text-[65px] desktop:text-[56px] largeTablet:text-[50px] mediumTablet:text-[40px] smallTablet:text-[36px] largePhone:text-[35px] smallPhone:text-[33px] font-black text-fontColor wideScreen:leading-[1.3] mediumTablet:leading-[1.2] smallPhone:leading-[1.1] mb-4'>Enhance your <br /> knowledge</h1>
                            <p className='font-poppins font-medium wideScreen:text-lg largeTablet:text-base mediumTablet:text-sm smallPhone:text-sm mb-4'>Follow us to stay updated with technology <br /> and grow your technical knowledge.</p>
