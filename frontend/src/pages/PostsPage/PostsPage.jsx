    ...
    return (
        <>
            <div className="article-wrapper flex items-center justify-center flex-col w-fit mx-auto">
                <h1 className='font-poppins block mx-auto wideScreen:text-[52px] desktop:text-[46px] largeTablet:text-[42px] mediumTablet:text-[36px] smallTablet:text-[32px] largePhone:text-[30px] font-medium text-fontColor mt-8 mb-8'>{search === '' ? 'All Posts' : search.slice(5).replace('%20', " ")}</h1>
