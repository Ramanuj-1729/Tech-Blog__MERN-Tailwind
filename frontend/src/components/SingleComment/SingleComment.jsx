...
const SingleComment = ({ comment }) => {
    ...
    return (
        <div className='comment-wrapper'>
            <div className="comment mt-6 flex space-x-4">
                <div className="avatar bg-gray1 w-10 h-10 rounded-full text-xl flex items-center justify-center text-white"><i className="fa-solid fa-user"></i></div>
                <div className="info">
