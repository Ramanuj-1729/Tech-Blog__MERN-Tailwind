    ...
    return (
        <>
            <div className="comment-rate-wrapper p-4 shadow-[0_5px_60px_-15px_rgba(0,0,0,0.2)] rounded">
                <h1 className='font-poppins block mx-auto wideScreen:text-3xl desktop:text-2xl font-semibold text-fontColor mt-2 mb-4'>Leave a comment & Rate this article</h1>

                <form onSubmit={handleSubmit}>
                    <div className="form-inputs font-poppins space-y-5 wideScreen:text-lg desktop:text-base">
                        <div className="rateIt-input border-2 border-gray2 rounded-[5px] wideScreen:p-3 desktop:p-2 flex item-center space-x-5">
                            <span className='text-gray2'>Rate it</span>
                            <StarRating getStar={getStar} />
                        </div>
                        <div className="name-input border-2 border-gray2 rounded-[5px] wideScreen:p-3 desktop:p-2">
                        ...
                        <div className="email-input border-2 border-gray2 rounded-[5px] wideScreen:p-3 desktop:p-2">
                        ...
                        <div className="comment-input border-2 border-gray2 rounded-[5px] wideScreen:p-3 desktop:p-2">
                    ...
                    <div className="form-button space-x-5 flex justify-end items-center mb-3">
                        {loader === true ? <Loader /> : ""}
                        <button type='reset' className='wideScreen:text-xl desktop:text-lg font-normal tracking-wider'>Clear</button>
